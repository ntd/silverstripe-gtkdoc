...
class Gtkdoc extends Page
{
    ...
    public static $icon = 'gtkdoc/images/gtkdoc';

    public static $description = 'Incorporates into the pages tree an ebook generated by gtk-doc';
...
class GtkdocSection extends DataObject
{
     ...
     */
    public static function fetchSection($root, $filename)
    {
...
class GtkdocControllerSearchExtension extends Extension
{
    ...
    private static $search_action = '/home/SearchForm';

    private static function merge(&$matches, $possible_matches)
    {
     ...
     */
    public static function setSearchAction($action)
    {
